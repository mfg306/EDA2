...
public class Programa {
	...
	public static void main(String[] args) {
		...
		if (!roturasManometrosTotal.containsAll(roturasManometrosLineas))
			roturasManometrosTotal.addAll(roturasManometrosLineas);
		...
		if (!roturasContadoresTotal.containsAll(roturasContadoresLineas))
			roturasContadoresTotal.addAll(roturasContadoresLineas);
