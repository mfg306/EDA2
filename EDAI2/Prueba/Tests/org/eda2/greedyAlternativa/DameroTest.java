...
//		Damero damero = new Damero(3,3);
//		double consumoCasillaGeneral = damero.getLitrosEdificio(1, 2, damero.getParEdificios(),"D");
...
//		Contador c = new Contador(5000,0,1,"D");
//		
//		d.setParEdificioContador(0, 1, c);
//		
...
//	@Test
//	public void TestComprobarIndiceContador() {
//		Damero d = new Damero(3,3);
//		Contador c = new Contador(25000,0,2,"M");
...
//		d.setParEdificioContador(0, 2, c);
//		
//		String[] coords = d.obtenerCoordenadas(c);
//		Integer i = Integer.parseInt(coords[0]);
//		Integer j = Integer.parseInt(coords[1]);
//		
//		if(i.equals(0) && j.equals(2)) condicion = true;
//		
//		Assert.assertTrue(condicion);
//	}
//	
...
//	}
	...
	public void TestResolverConsumidoresGreedy() {
		...
		d.setParEdificioContador(0, 2, new Contador(20,0,2,"D"));
		d.setParEdificioContador(0, 2, c1); //ROTURA
		...
		d.setParEdificioContador(1, 1, new Contador(0,1,1,"I"));
		d.setParEdificioContador(1, 1, new Contador(0,1,1,"D"));
		d.setParEdificioContador(1, 1, c2); //ROTURA
		
		d.setParEdificioContador(1, 2, new Contador(0,1,2,"I"));
		d.setParEdificioContador(1, 2, new Contador(0,1,2,"D"));
		
		Assert.assertEquals(expectedResult, d.resolverConsumidoresGreedy());
	}
